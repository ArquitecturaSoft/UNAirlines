...
class gsp_0_flightClasscreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/flightClass/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',33,['bean':(flightClassInstance),'var':("error")],3)
printHtmlPart(14)
})
invokeTag('hasErrors','g',35,['bean':(flightClassInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(15)
...
invokeTag('form','g',56,['url':([resource:flightClassInstance, action:'save'])],2)
printHtmlPart(18)
})
...
public static final long LAST_MODIFIED = 1428730175332L
