...
class gsp_0_admincreate_gsp extends GroovyPage {
...
printHtmlPart(2)
invokeTag('set','g',17,['var':("entityName"),'value':(message(code: 'admin.label', default: 'Admin'))],-1)
printHtmlPart(2)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',34,['bean':(adminInstance),'var':("error")],3)
printHtmlPart(14)
})
invokeTag('hasErrors','g',36,['bean':(adminInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(15)
...
invokeTag('form','g',58,['url':([resource:adminInstance, action:'save'])],2)
printHtmlPart(18)
})
