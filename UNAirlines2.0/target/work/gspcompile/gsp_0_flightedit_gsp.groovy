...
class gsp_0_flightedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/flight/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',33,['bean':(flightInstance),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',35,['bean':(flightInstance)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
invokeTag('hiddenField','g',37,['name':("version"),'value':(flightInstance?.version)],-1)
printHtmlPart(18)
...
invokeTag('form','g',58,['url':([resource:flightInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1431931138672L
