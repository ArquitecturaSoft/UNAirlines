...
class gsp_0_personlogin_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/person/login.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',47,['controller':("Customer"),'action':("create"),'method':("post")],2)
printHtmlPart(10)
createClosureForHtmlPart(11, 2)
invokeTag('form','g',52,['controller':("Person"),'action':("login"),'method':("post")],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
...
invokeTag('form','g',68,['controller':("Person"),'action':("doLogin"),'method':("post")],2)
printHtmlPart(15)
})
invokeTag('captureBody','sitemesh',74,['class':("homepage")],1)
printHtmlPart(16)
}
...
public static final long LAST_MODIFIED = 1434079487791L
