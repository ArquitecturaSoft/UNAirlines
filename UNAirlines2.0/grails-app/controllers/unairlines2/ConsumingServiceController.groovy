...
class ConsumingServiceController {
    ...
    def index = {
        ...
        String resul2 = proxy2.serviceMethod("VUELO BOGOTA-MEDELLIN,BOGOTA,MEDELLIN,200000.0,2015-03-18,2015-03-18,1",3,"Juan","Mendez","12345678","2015-08-08","ceparadac@unal.edu.co") 
        println(resul2)
