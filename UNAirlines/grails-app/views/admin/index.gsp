		...
		<div id="list-admin" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="surname" title="${message(code: 'admin.surname.label', default: 'Surname')}" />
				...
				<g:each in="${adminInstanceList}" status="i" var="adminInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: adminInstance, field: "surname")}</td>
					
						<td>${fieldValue(bean: adminInstance, field: "email")}</td>
